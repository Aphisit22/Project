                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row['status'] == 'pending'): ?>
                                                ...
                                                <a href="?reject=<?= $row['id'] ?>" class="btn btn-danger btn-sm reject-btn" data-reject="<?= $row['id'] ?>">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('.reject-btn').forEach(function(btn) {
            btn.addEventListener('click', function(e) {
                e.preventDefault();
                const rejectId = this.getAttribute('data-reject');
                Swal.fire({
                    title: 'ยืนยันการปฏิเสธ?',
                    text: "คุณแน่ใจว่าต้องการปฏิเสธการจองนี้?",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        window.location = '?reject=' + rejectId;
                    }
                });
            });
        });
